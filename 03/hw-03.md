...
- [count_vm](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/count_vm.tf)
- ![img_2.png](img_2.png)
...
```
- [for_each-vm](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/%20for_each-vm.tf)
- [vms_platform](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/vms_platform.tf)

При желании внесите в переменную все возможные параметры.
4. ВМ из пункта 2.1 должны создаваться после создания ВМ из пункта 2.2.
5. Используйте функцию file в local-переменной для считывания ключа ~/.ssh/id_rsa.pub и его последующего использования в блоке metadata, взятому из ДЗ 2.

- [locals](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/locals.tf)
...
- [disk_vm](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/disk_vm.tf)
- ![img_3.png](img_3.png)
------
...
[ansible.tf](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/ansible.tf)
```
...
```
[hosts.tftpl](https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/hosts.tftpl)
```
[webservers]
%{~ for i in webservers ~}
...
[Project](https://github.com/Dmitrywh1/ter-homeworks/tree/terraform-03/03/src)
