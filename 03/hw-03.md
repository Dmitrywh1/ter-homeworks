...
- https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/count_vm.tf
- ![img_2.png](img_2.png)
...
```
- https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/%20for_each-vm.tf
- https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/vms_platform.tf

При желании внесите в переменную все возможные параметры.
4. ВМ из пункта 2.1 должны создаваться после создания ВМ из пункта 2.2.
5. Используйте функцию file в local-переменной для считывания ключа ~/.ssh/id_rsa.pub и его последующего использования в блоке metadata, взятому из ДЗ 2.
- https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/locals.tf
...
- https://github.com/Dmitrywh1/ter-homeworks/blob/main/03/src/disk_vm.tf
- ![img_3.png](img_3.png)
------
